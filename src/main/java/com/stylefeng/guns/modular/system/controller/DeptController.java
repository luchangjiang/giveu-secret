...
public class DeptController extends BaseController {
    ...
    public String deptUpdate(@PathVariable Integer deptId, Model model) {
        ...
        model.addAttribute(secretDept);
        model.addAttribute("pName", ConstantFactory.me().getDeptName(secretDept.getPid()));
        LogObjectHolder.me().set(secretDept);
    ...
    @Permission
    @ResponseBody
    public Object add(SecretDept secretDept) {
        if (ToolUtil.isOneEmpty(secretDept, secretDept.getSimpleName())) {
            throw new BussinessException(BizExceptionEnum.REQUEST_NULL);
        }
        return this.deptMapper.insert(secretDept);
    }
    ...
    @Permission
    @ResponseBody
    public Object update(SecretDept secretDept) {
        if (ToolUtil.isEmpty(secretDept) || secretDept.getId() == null) {
            throw new BussinessException(BizExceptionEnum.REQUEST_NULL);
        }
        deptMapper.updateById(secretDept);
