...
public class DictController extends BaseController {
    ...
    public String deptUpdate(@PathVariable Integer dictId, Model model) {
        ...
        model.addAttribute("secretDict", secretDict);
        List<SecretDict> subSecretDicts = dictMapper.selectList(new EntityWrapper<SecretDict>().eq("pid", dictId));
        model.addAttribute("subSecretDicts", subSecretDicts);
        LogObjectHolder.me().set(secretDict);
