...
public class ShiroDbRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken)
        ...
        SecretUser secretUser = shiroFactory.user(token.getUsername());
        ShiroUser shiroUser = shiroFactory.shiroUser(secretUser);
        SimpleAuthenticationInfo info = shiroFactory.info(shiroUser, secretUser, super.getName());
        return info;
    }
